...
CREATE TABLE IF NOT EXISTS `mydb`.`Reaccion` (
  ...
  INDEX `fk_Reaccion_UsuarioChat1_idx` (`UsuarioChat_nombreUsuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`UsuarioChat` (
  ...
  INDEX `fk_UsuarioChat_Chat1_idx` (`Chat_nombreChat` ASC) VISIBLE,
